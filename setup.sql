...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS subscribed_until TIMESTAMP WITH TIME ZONE;
...
-- 1d. Tabel admin_users untuk role aplikasi (bukan role auth)
...
-- Admin users policies (user scoped)
