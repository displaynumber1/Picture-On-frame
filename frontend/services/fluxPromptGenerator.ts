      ...
      if (isSingleHand) {
        ...
        if (isFootwearCategory) {
          clauses.push(
            ...
            'product size not constrained by palm',
            'sandal may extend beyond the hand while remaining proportional',
            'hand supports the product, not the other way around',
